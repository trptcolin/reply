...
# haxx
java -cp /home/colin/Projects/clojure/clojure-1.4.0-master-SNAPSHOT.jar:/home/colin/Projects/jline2/target/scala-2.9.0-1/jline_2.9.0-1-2.10.0-SNAPSHOT.jar:lib/jansi-1.4.jar:classes/:src/ clojure.main -m reply.core
